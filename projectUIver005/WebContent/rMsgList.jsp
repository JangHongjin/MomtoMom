			...
			<c:forEach var="data" items="${getAllReceiveMessage}">
				<div class="row">
					<div class="cell title">
						<a
							href="${path}/message/getAllReceiveMessage.do?rid=${data.msgSid}">${data.msgSid}</a>
					</div>
					...
					<!-- 	<button class="button" onclick="">삭제</button> -->
						<input class="button" value="삭제" onclick="location.href='${path}/message/deleteMessage.do?msgNo=${data.msgNo}&rid=${rid}'" style="
    width: 70px;
">
						<!-- <input class="button" value="삭제" onclick="location.href='/projectUIver006/message/deleteMessage.do?msgNo=42&amp;rid=유진행님'" style="
    width: 90px;
"> -->
					</div>
				</div>
