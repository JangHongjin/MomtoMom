...
<%@ page import="model.domain.MessageDTO" %>
	...
	<div class="wrapper" style="width: 1229px;">
		...
		<div class="table">
			<div class="row header">
				<div class="cell" style="width: 124px;">보낸이</div>
			 ...
			 <c:forEach var="data" items="${getAllReceiveMessage}">
				<div class="row">
					<div class="cell title, dropdown">
						
						<a href="${path}/message/getAllReceiveMessage.do?rid=${data.msgSid}" ><span id="idValue">${data.msgSid}</span></a>
						
						<div class="dropdown-content">
							<a href="#" onclick="location.href='${path}/user/getUser2.do?usrNick=${data.msgSid}'">정보보기</a>
							<a href="#" onclick="testFun('${data.msgSid}')">쪽지보내기</a>
						</div>
					...
					<div class="cell" style="width: 104px;">${data.msgDate}</div>
 					 <div class="cell" style="width: 74px;"> 
							<input class="button2" value="삭제"
							onclick="location.href='${path}/message/deleteMessage.do?msgNo=${data.msgNo}&rid=${rid}'"
	...
	<div class="s-12 l-6">
		<a class="right text-size-12"
			...
			coding<br> by mom2mom Team
							...
							action="${path}/message/writeMessage.do" method="post" style="width: 536px;">
								<div class="container" style="height: 333px;" id="idViewChoice">
									...
									<!-- <input	type="text" name="msgRid" id="msgRid"><br> -->
								...
								name="msgCon" required style="height: 65%; width: 406px"><br> 
 									...
 									<input class="btn" type="submit" value="보내기">
										<input class="btn" type="button" value="취소" onclick="location.href='${path}/message/getAllReceiveMessage.do?rid=${sessionScope.usrNick}'">
