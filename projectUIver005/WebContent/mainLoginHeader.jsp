						...
						<form action="#" method="post">
							<div class="dropdown">
								...
								<c:when test="${message == 'success'}">
									<button class="dropbtn">${sessionScope.usrNick} 님 환영합니다!&nbsp;<div class="fa fa-bars" aria-hidden="true"></div></button>
								...
								<c:otherwise>
									<button class="dropbtn">${sessionScope.usrNick} 님&nbsp;<div class="fa fa-bars" aria-hidden="true"></div></button>
									<div class="dropdown-content">
									    <!-- <a href="#" onclick="document.getElementById('id01').style.display='block'"">내 정보</a> -->
									    <a href="#" onclick="location.href='${path}/user/getUser.do?usrNick=${sessionScope.usrNick}'">내 정보</a>
									    <a href="board.jsp">내 글</a>
