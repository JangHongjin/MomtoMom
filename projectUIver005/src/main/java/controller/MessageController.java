...
public class MessageController {
   // 예외처리
      ...
      public ModelAndView writeMessage(MessageDTO message) throws Exception {
         //System.out.println(message.getMsgRid() + message.getMsgSid() + message.getMsgCon());
         ModelAndView mv = new ModelAndView();
         Mom2momService.writeMessage(message);
         mv.setViewName("sMsgList");
         mv.addObject("getAllSendMessage", Mom2momService.getAllSendMessage(message.getMsgSid()));
         return mv;
      }
...
/*      // 받은 쪽지함에서 보내기
      ...
      public ModelAndView writeMessage(MessageDTO message) throws Exception {
         ...
         mv.addObject("getAllReceiveMessage", Mom2momService.getAllReceiveMessage(message.getMsgRid()));
         return mv;
      }
      */
      
   /*   // 보낸 쪽지함에서 보내기
      @RequestMapping(value = "writeMessage2.do")
      public ModelAndView writeMessage2(MessageDTO message) throws Exception {
         //System.out.println(message.getMsgRid() + message.getMsgSid() + message.getMsgCon());
         ModelAndView mv = new ModelAndView();
         Mom2momService.writeMessage(message);
         mv.setViewName("sMsgList");
         mv.addObject("getAllSendMessage", Mom2momService.getAllSendMessage(message.getMsgRid()));
         return mv;
      }*/
